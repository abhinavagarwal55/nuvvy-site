          ...
          <section className="bg-white pt-6 pb-12">
            <div className="bg-[#F8FAF8] rounded-3xl px-6 py-12 md:px-12 md:py-16 shadow-sm">
              <div className="space-y-10">
                ...
                >
                  <div className="bg-white rounded-2xl shadow-md group-hover:shadow-md group-hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 overflow-hidden flex flex-col">
                    ...
                    <div className="p-6 md:p-8 flex-1 flex flex-col">
                      ...
                      <p className="text-base md:text-lg text-gray-700 leading-relaxed">
                        Ongoing expert maintenance that keeps your plants healthy, pest-free, and thriving.
                      </p>
                    </div>
                  </div>
                </a>
                ...
                >
                  <div className="bg-white rounded-2xl shadow-md group-hover:shadow-md group-hover:-translate-y-1 active:scale-[0.98] transition-all duration-200 overflow-hidden flex flex-col">
                    ...
                    <div className="relative w-full aspect-[4/3] overflow-hidden bg-gray-100">
                      <Image
                        src={publicImage("/images/plant_ordering_card.png")}
              ...
              <div className="text-center pt-4">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="inline-flex items-center justify-center gap-2 bg-[#25D366] hover:bg-[#20BA5A] text-white font-semibold px-8 py-3 rounded-lg transition-colors shadow-lg"
                >
                  <svg
                    className="w-5 h-5"
                    fill="currentColor"
                        ...
                        return (
                          <div key={idx} className="relative">
                            ...
                            <div className="relative w-full h-48 rounded-2xl overflow-hidden bg-gray-100">
                              <img
                                src={idx === 0 ? publicImage("/images/female_horticulturist_landscape.png") : idx === 4 ? publicImage("/images/post_completion.png") : step.imageUrl}
                                alt={stepTitles[idx]}
            ...
            <div className="bg-[#F8FAF8] rounded-3xl shadow-sm px-6 py-12 md:px-12 md:py-16">
                ...
                <div className="space-y-10">
                  ...
                  <div className="relative">
                    <div className="relative w-full h-48 rounded-2xl overflow-hidden bg-gray-100">
                      <img
                        src={publicImage("/images/plant_selection_step1.png")}
                  ...
                  <div className="relative">
                    <div className="relative w-full h-48 rounded-2xl overflow-hidden bg-gray-100">
                      <img
                        src={publicImage("/images/plant_sourcing_step2.png")}
                  ...
                  <div className="relative">
                    <div className="relative w-full h-48 rounded-2xl overflow-hidden bg-gray-100">
                      <img
                        src={publicImage("/images/Plant_install_step3.png")}
                  ...
                  <div className="relative">
                    <div className="relative w-full h-48 rounded-2xl overflow-hidden bg-gray-100">
                      <img
                        src={publicImage("/images/Balcony_Enjoy.png")}
                        alt="Ready to Enjoy"
                        className="w-full h-full object-cover"
                      />
                    </div>
          ...
          <section id="contact" className="py-12 bg-gradient-to-br from-green-50 to-gray-50">
            <div className="max-w-2xl mx-auto text-center">
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="block mx-auto bg-[#25D366] hover:bg-[#20BA5A] text-white font-semibold px-6 py-3 rounded-full text-center transition-colors shadow-lg flex items-center justify-center gap-2 max-w-md"
              >
                <svg
                  className="w-5 h-5"
                  fill="currentColor"
