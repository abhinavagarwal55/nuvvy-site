...
export default function HomepagePreviewContent({
  ...
  whatsappNumber,
  whatsappMessage,
}: HomepagePreviewContentProps) {
  const [viewMode, setViewMode] = useState<"desktop" | "mobile">("desktop");

  return (
    <main className="min-h-screen bg-white">
      {/* Preview Banner with Viewport Toggle */}
      ...
      <div
        className={
          viewMode === "mobile"
            ? "w-[390px] mx-auto border border-gray-300 rounded-xl shadow-sm bg-white min-h-screen overflow-y-auto"
            : "w-full"
        }
      >
